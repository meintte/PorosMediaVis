...
// configuration step. It creates a namespace called `PorosMediaVis`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", PorosMediaVis::cmake::project_name, PorosMediaVis::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", PorosMediaVis::cmake::project_version);
      return EXIT_SUCCESS;
    }
